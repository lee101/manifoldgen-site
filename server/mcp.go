...
func manifoldGenerateSchema() map[string]interface{} {
	properties := map[string]interface{}{
		...
		"service_tier": map[string]interface{}{
			"type": "string", "enum": []string{"standard", "fast", "xfast"},
			"description": "Music or animation latency lane. Fast costs 1.5x for music; XFast costs 2x and uses an isolated priority queue.",
		},
		...
		"max_quality":          map[string]interface{}{"type": "boolean", "description": "higher quality."},
		"mask_url":             map[string]interface{}{"type": "string", "description": "Optional first-frame mask or cutout still ."},
