...
export const FOOTER_TOOL_GROUPS: { title: string; links: FooterLink[]; more?: FooterLink }[] = [
  ...
  {
    title: 'Motion & audio',
    links: byHref(['/tools/character-animator', '/tools/cinematic-cameras', '/tools/video-background-remover', '/tools/trailer-agent', '/tools/character-swap', '/tools/character-swap-exact', '/tools/reference-video', '/tools/music-generator', '/tools/lofi-loop', '/voice']),
