...
const tools = [
  ...
  { href: '/tools/h3-image', name: 'H3 Image', label: 'IMAGE GENERATOR', copy: 'Create a finished image with H3.', kind: 'image', src: 'https://manifoldgenstatic.manifoldgen.com/gallery/originals/h3_dev_glass_hummingbird_20260816.png', meta: 'H3 · real generation' },
  { href: '/tools/h3-image-editor', name: 'H3 Image Editor', label: 'IMAGE EDITOR', copy: 'Edit a source image with H3.', kind: 'image', src: 'https://manifoldgenstatic.manifoldgen.com/gallery/originals/h3_dev_glass_hummingbird_greenhouse_20260816.png', meta: 'H3 · real edit' },
